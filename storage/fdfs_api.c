...
static int downloadFileCallback(void *arg, const int64_t file_size, const char *data, const int current_size)
{
    return 0;
}
...
int upload_file_by_buff(const char *file_buff, const int file_size, const char *file_ext_name, char *file_id, char *storage_ip)
{
    ...
    *group_name = '\0';
    ...
    result = storage_upload_by_filebuff1(pTrackerServer, pStorageServer, 
        store_path_index, file_buff, file_size, file_ext_name, NULL, 0, "", file_id);
